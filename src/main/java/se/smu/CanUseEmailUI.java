/**
 * title : CanUseEmailUI.java
 * author : 김한동 (aggsae@gmail.com)
 * version : 0.0.0.
 * since : 2018 - 05 - 07
 * brief : 이메일 중복확인 메세지 출력
 * -----------------------------------
 * history
...
public class CanUseEmailUI extends JFrame{
	private JPanel contentPane;

	public CanUseEmailUI() {
		...
		txtpnAsd.setText("사용 가능한 이메일입니다.");
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CanUseEmailUI frame = new CanUseEmailUI();

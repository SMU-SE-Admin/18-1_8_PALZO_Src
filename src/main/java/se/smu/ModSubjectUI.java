 ...
 *   ±èÇÑµ¿       3.1.0.   2018-05-29          ±âÁ¸ ÀúÀåµÈ °ú¸ñ¸íÀ» ÅëÇØ °ú¸ñÀ» È®ÀÎÇÏ°í ¼öÁ¤ÇÒ ¼ö ÀÖ´Â ±â´É ±¸Çö
 *   ±èÇÑµ¿       3.2.0.   2018-05-29                       »èÁ¦ ¹öÆ° ¹× ±â´É Ãß°¡
 * -----------------------------------
 */
...
public class ModSubjectUI extends JFrame {
	...
	public ModSubjectUI(String subjectBtnName) {
		...
		deleteButton.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));

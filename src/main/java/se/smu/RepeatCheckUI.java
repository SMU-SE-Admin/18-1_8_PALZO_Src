/**
 * title : RepeatCheckUI.java
 * author : 김한동 (aggsae@gmail.com)
 * version : 0.0.0.
 * since : 2018 - 05 - 07
 * brief : 중복확인 요청 메세지 출력
 * -----------------------------------
 * history
...
public class RepeatCheckUI extends JFrame{
	private JPanel contentPane;

	public RepeatCheckUI() {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RepeatCheckUI frame = new RepeatCheckUI();
